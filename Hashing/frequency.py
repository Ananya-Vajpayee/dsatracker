#brute force approach to find the highest and lowest frequency elements in an array
...
if __name__ == "__main__":
    ...
    fc.countFreq(arr)         
# O(N^2)-TIME COMPLEXITY                  # Run frequency analysis

#hashing approach to find the highest and lowest frequency elements in an array
class FrequencyCounterHash:
